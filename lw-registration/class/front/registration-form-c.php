			...
			<select name="lw_emergency_area_code" id="lw_emergency_area_code">
               ...
               <div class="lw_tabcontent">
                  <div class="lw-form-group">
                     ...
                     <input type="text" placeholder="Livewire Username" class="required username_min_3 username_not_same username_valid user_3_consecutive"  id="lw_username"    name="lw_username" maxlength="100">
