            ...
            <form id="LwRegistrationForm" class="lw-form" method="post">
               ...
               <div class="lw-form-group">
                ...
                <div class="lw-form-group">
                   ...
                   <input type="text" placeholder="Livewire Username" class="required username_min_3 user_3_consecutive username_valid"  name="lw_username" id="lw_username" maxlength="100">
